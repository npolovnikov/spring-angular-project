...
export class CourseService {
  ...
  setStudent(iddCourse, iddStudent):Observable<Object>{
    const href = '/api/'+iddCourse+'/course';
    return this._httpClient.put(href, iddStudent);
  }

  setLesson(iddCourse, iddLesson):Observable<Object>{
    const href = '/api/'+iddLesson+'/course';
    return this._httpClient.put(href, iddLesson);
  }
}
